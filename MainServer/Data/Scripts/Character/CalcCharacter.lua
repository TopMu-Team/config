...
CLASS_MG_REGULAR_DEFENSE_RATE = 3.0
CLASS_MG_REGULAR_DEFENSE_SUCCESS_RATE_PVP = 1.0
CLASS_MG_REGULAR_DEFENSE_SUCCESS_RATE_PVM = 1.0

CLASS_MG_ELEMENTAL_ATK_RATE = 6.0
CLASS_MG_ELEMENTAL_ATK_SUCCESS_RATE_PVP = 3.0
CLASS_MG_ELEMENTAL_ATK_SUCCESS_RATE_PVM = 3.0
...
CLASS_SUM_REGULAR_ATK_MAGIC_RATE = 0.9
...
CLASS_SUM_ELEMENTAL_ATK_RATE = 6.0
CLASS_SUM_ELEMENTAL_ATK_SUCCESS_RATE_PVP = 3.0
CLASS_SUM_ELEMENTAL_ATK_SUCCESS_RATE_PVM = 3.0
...
CLASS_DL_REGULAR_DEFENSE_SUCCESS_RATE_PVP = 2.0
CLASS_DL_REGULAR_DEFENSE_SUCCESS_RATE_PVM = 1.0

CLASS_DL_ELEMENTAL_ATK_RATE = 6.0
CLASS_DL_ELEMENTAL_ATK_SUCCESS_RATE_PVP = 3.0
CLASS_DL_ELEMENTAL_ATK_SUCCESS_RATE_PVM = 3.0
...
CLASS_LW_REGULAR_ATK_MAGIC_RATE = 3.5
...
CLASS_LW_ELEMENTAL_ATK_RATE = 6.0
CLASS_LW_ELEMENTAL_ATK_SUCCESS_RATE_PVP = 3.0
CLASS_LW_ELEMENTAL_ATK_SUCCESS_RATE_PVM = 3.0
...
CLASS_LEM_ELEMENTAL_ATK_RATE = 6.0
CLASS_LEM_ELEMENTAL_ATK_SUCCESS_RATE_PVP = 3.0
CLASS_LEM_ELEMENTAL_ATK_SUCCESS_RATE_PVM = 3.0

CLASS_LEM_ELEMENTAL_DEFENSE_RATE = 2.0
CLASS_LEM_ELEMENTAL_DEFENSE_SUCCESS_RATE = 1.0

-- LK
CLASS_LK_REGULAR_ATK_RATE = 3.5
...
CLASS_LK_ELEMENTAL_ATK_RATE = 6.0
CLASS_LK_ELEMENTAL_ATK_SUCCESS_RATE_PVP = 3.0
CLASS_LK_ELEMENTAL_ATK_SUCCESS_RATE_PVM = 3.0
...
function KnightMagicDamageCalc(Energy)
	...
	MagicDamageMin = 200 * CLASS_DK_REGULAR_ATK_MAGIC_RATE -- Minimum Magic Damage
	MagicDamageMax = 200 * CLASS_DK_REGULAR_ATK_MAGIC_RATE -- Maximum Magic Damage
